...
<div class="card text-center">
  ...
  <div class="card-body">
    ...
    <div class="container">
        ...
        <p>
	        <a class="btn btn-lg btn-primary next_queue" href="" role="button" type="submit"  value="Refresh Page" onClick="document.location.reload(true)">
	        	
	        	Next &nbsp;
	        	<span class="fa fa-chevron-circle-right">
	        	</span><a href="index.php" target="_BLANK"></a>
	        </a>
        </p>
		</div>
		<?php
